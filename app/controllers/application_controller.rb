...
#
# Write a SecretsController using a before_action to prevent
# any route from being accessed without logging in.
#
# Use the specs as your guide, but we'd like the following behavior.
#
...
#
# Once logged in, a user should see the welcome page.
# This page should greet the user and link them to the secret page.
#
# The content and URL of the secret page are up to you.
# However, if we visit that URL without logging in,
# we should be redirected to the login page.
# Under no circumstances should we allow people
# who are not logged in to see the secrets.
